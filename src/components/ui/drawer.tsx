	...
	return (
		<DrawerPrimitive.Portal>
			...
			<DrawerPrimitive.Content
				class={cn(
					"fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-xl border border-neutral-300 bg-white after:absolute after:inset-x-0 after:top-full after:h-[50%] after:bg-inherit data-[transitioning]:transition-transform data-[transitioning]:duration-200 md:select-none",
					local.class,
				)}
				{...rest}
			>
...
export const DrawerHeader = (props: ComponentProps<"div">) => {
	...
	return (
		<div
			class={cn("grid gap-1.5 py-4 px-16 text-center sm:text-left", local.class)}
			{...rest}
		/>
	);
};
